...
def test_blame_folder_ignore_revs(git_repo):
    ...
    assert blame_folder(git_repo.api, tree, ignore_revs=[str(commit)]) == (2, [('Tony Stark <tony@avengers.com>', 1), ('Steve Rogers <captain@avengers.com>', 1)], [('test.txt', (2, [('Tony Stark <tony@avengers.com>', 1), ('Steve Rogers <captain@avengers.com>', 1)]))])
...
def test_blame_folder_with_sub_folders_ignore_revs(git_repo):
    ...
    assert blame_folder(git_repo.api, tree, ignore_revs=[str(commit)]) == (3, [('Steve Rogers <captain@avengers.com>', 1), ('Tony Stark <tony@avengers.com>', 2)], [('sub_folder', (1, [('Steve Rogers <captain@avengers.com>', 1)]), [('bottom.txt', (1, [('Steve Rogers <captain@avengers.com>', 1)]))]), ('top.txt', (2, [('Tony Stark <tony@avengers.com>', 2)]))])
